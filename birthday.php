...
<body onload="slider()">
    ...
    <center><h1><center>BIRTHDAYS</center></h1>
<p><h4>Whether an all-day or the ultimate extravaganza that lasts well into the wee hours, our Urban Events team is here to make sure all your birthday party wishes come true so you can kick back, drink up and enjoy your special day!</h4></p>
...
$q="insert into birthday(name,contact,email,query)values('".$name."','".$con."','".$email."','".$query."');";
