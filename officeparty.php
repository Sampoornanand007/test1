...
<body onload="slider()">
    ...
    <center><h1><center>OFFICE</center></h1>
<p><h4>From formal, to not-so-formal, our flexible event spaces can cater to your every need for meetings and conferences large or small, and our dedicated event team can assist with all aspects of your event planning.</h4></p>
...
$q="insert into officeparty(name,contact,email,query)values('".$name."','".$con."','".$email."','".$query."');";
