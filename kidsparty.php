...
color:black;
   ...
   i{
	...
	<script>
        ...
        a[3]=new Image();
		a[3].src="img/kp12.jpg";

        a[4]=new Image();
		a[4].src="img/kp13.jpg";

        a[5]=new Image();
        a[5].src="img/kp15.jpg";
...
$q="insert into kidsparty(name,contact,email,query)values('".$name."','".$con."','".$email."','".$query."');";
